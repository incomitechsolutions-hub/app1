...
@section('content')
    <div class="mx-auto max-w-7xl space-y-6">
        ...
        <form method="post" action="{{ route('admin.course-catalog.courses.store') }}" class="space-y-6" x-data="{ tab: 'details' }">
            @csrf
