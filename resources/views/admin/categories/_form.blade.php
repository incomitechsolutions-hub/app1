...
<div class="admin-panel space-y-6 p-6 md:p-8">
    <div>
        ...
        <p class="mt-1 text-sm text-slate-500">Name, Slug, Hierarchie und Sichtbarkeit der Kategorie.</p>
    </div>
    <div class="grid gap-5 md:grid-cols-2">
        ...
        <div class="md:col-span-2" x-data="{ len: {{ strlen($descOld) }} }">
            ...
            <textarea id="description" name="description" rows="4" maxlength="200"
                ...
                class="mt-1 block w-full rounded-lg border border-slate-300 px-3 py-2 text-sm shadow-sm focus:border-slate-500 focus:ring-slate-500">{{ $descOld }}</textarea>
