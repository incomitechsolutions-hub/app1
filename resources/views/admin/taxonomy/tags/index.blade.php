...
@section('title', 'Taxonomy Skills')
@section('breadcrumb', 'Kategorien')

@section('content')
    <div class="mx-auto max-w-5xl space-y-6">
        <div class="flex flex-wrap items-center justify-between gap-4">
            <h1 class="text-3xl font-bold text-slate-900">Taxonomy Skills</h1>
            <a href="{{ route('admin.taxonomy.tags.create') }}"
                    ...
                    @forelse ($tags as $tag)
                        <tr class="hover:bg-slate-50/70"
                            ...
                            <td class="px-4 py-2 text-right">
                                <a href="{{ route('admin.taxonomy.tags.edit', $tag) }}" class="text-sky-600 hover:underline">Bearbeiten</a>
                                <form method="post" action="{{ route('admin.taxonomy.tags.destroy', $tag) }}" class="ml-3 inline"
